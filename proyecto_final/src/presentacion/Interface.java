...
public class Interface extends JFrame {
	...
	public Interface() {
		...
		//Acciones
					...
					searchUser.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							try {
								...
								JOptionPane.showMessageDialog(null, "Usuario encontrado!", "Mensaje del sistema", JOptionPane.PLAIN_MESSAGE);
							}catch(Exception p) {
								System.out.println(p);
								JOptionPane.showMessageDialog(null, "Usuario no encotrado. Verifique la C.I", "Mensaje del sistema", JOptionPane.ERROR_MESSAGE);
							}
							inputSearch.setText("Ingrese CI de usuario...");
			...
			//Se cargan todos los usuarios desde la base de datos y luego se crean y guardan en un ArrayList en Java, para luego listarlos.
				man.altaUsuario();
